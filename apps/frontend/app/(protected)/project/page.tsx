...
export default function ActiveProjectsPage() {
    ...
    useEffect(() => {
        const fetchActiveProjects = async () => {
            ...
            try {
                const res = await projectService.listProjects(activeOrg.id, { archived: false })
                ...
                <div className="mb-8 md:mb-10">
                    <div className="flex items-center gap-3 mb-3">
                        <div className="p-2 bg-neutral-800/50 rounded-xl border border-neutral-700/50">
                            <FolderOpen className="w-6 h-6 md:w-7 md:h-7 text-neutral-300" />
                        </div>
                    ...
                    <p className="text-sm md:text-base text-neutral-400 max-w-2xl">
                        Manage your active projects and track their progress. Keep your team organized and productive.
                    </p>
                </div>
